      ...
      <div className="fixed inset-0 md:inset-8 bg-[#F9F9F9] md:rounded-lg z-50 flex flex-col max-h-screen md:max-h-[calc(100vh-4rem)]">
        ...
        <div className="flex items-center justify-between p-4 border-b border-gray-200">
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-lg font-semibold">Бронирование корта</h1>
          </div>
        ...
        {activeTab === "courts" && (
          <ConfirmationModal
            ...
            selectedSlots={state.selectedSlots}
            onSuccess={() => dispatch({ type: "SHOW_SUCCESS", payload: true })}
          />
        )}
...
function ConfirmationModal({ open, onOpenChange, selectedSlots, onSuccess }: ConfirmationModalProps) {
